/* ============================================================
   HTAT · Migración D1 — fotos de 5 a 9
   Pegar en: Dashboard → Workers & Pages → htat-api → D1 → htat → Consola

   ⚠️ IMPORTANTE: ejecutar ESTA migración ANTES de desplegar el
   nuevo Worker (deploy/worker-htat-api.js). Si el Worker se
   despliega sin las columnas, los INSERT fallan con
   "no such column: foto6".
